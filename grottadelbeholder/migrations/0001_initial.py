# Generated by Django 4.0.4 on 2022-09-06 12:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('CL', 'Classi'), ('RA', 'Razze'), ('MO', 'Mostri'), ('SP', 'Incantesimi')], default=None, max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('armorProficiency', models.CharField(choices=[('N', 'Nessuna'), ('L', 'Armature leggere'), ('M', 'Armature medie'), ('A', 'Tutte le armature')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.CharField(choices=[('V', 'Evocazione'), ('I', 'Illusione'), ('C', 'Invocazione'), ('A', 'Abiurazione'), ('N', 'Necromanzia'), ('T', 'Trasmutazione'), ('E', 'Ammaliamento'), ('D', 'Divinazione')], default='V', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
